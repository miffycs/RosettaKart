...
namespace Bose.Wearable
{
	public static class WearableConstants
	{
		...
		public const string DEVICE_CONNECTION_PERMISSION_ERROR =
			"[Bose Wearable] User has denied the \"Fine Location\" permission required to search for devices " +
		...
		// Editor Tooltips
		public const string SIMULATE_HARDWARE_DEVICE_TOOLTIP = "If enabled when built to an iOS player the normal plugin " +
		...
		// Runtime Dialogs
		public const string DEVICE_CONNECT_SUCCESS_MESSAGE = "Device connected successfully!";
		public const string DEVICE_CONNECT_FAILURE_MESSAGE = "Device failed to connect!";
		public const string DEVICE_CONNECTION_SEARCH_MESSAGE = "Select your Bose AR product";
		public const string DEVICE_CONNECT_SEARCH_FAILURE_MESSAGE =
			"Searching for devices failed. Location permissions are required.";
		public const string DEVICE_CONNECTION_UNDERWAY_MESSAGE = "Device connecting...";
		public const string DEVICE_DISCONNECTION_MESSAGE = "Device disconnected, please reconnect";
		public const string WAIT_FOR_CALIBRATION_MESSAGE = "Please look forward \nand remain still...";

		// Permissions and Services
		public const string GENERAL_PERMISSION_MESSAGE_FORMAT
			= "We need {0} permission before we can continue. Go to your device's Settings menu and allow " +
			"{0} for this app so we can connect your products.";
		public const string BLUETOOTH_PERMISSION_MESSAGE
			= "We need Bluetooth permission before we can continue. Go to your device's Settings menu and allow " +
			"Bluetooth Sharing for this app so we can connect your products.";
		public const string GENERAL_SERVICE_FORMAT
			= "We need {0} enabled on the device so we can connect your Bose AR-enabled product. Turn on {0} " +
